...
```zsh
% docker run -d --restart=always --name PGADMIN -p 5050:80 -e PGADMIN_DEFAULT_EMAIL=mail@domain.com -e PGADMIN_DEFAULT_PASSWORD=aA123456 -v pgadmin_data:/var/lib/pgadmin dpage/pgadmin4:latest
```
