...
```zsh
% pgloader mysql://emre:'**pass**'@80.240.19.57:3306/Blog postgresql://postgres:'aA123456'@127.0.0.1:5432/Blog

% pgloader mysql://emre:'}+/XLSt|QSotm-(Gu96&U9quLv?u%o'@80.240.19.57:3306/Blog postgresql://postgres:'aA123456'@127.0.0.1:5432/blog1

#or

vi pg.load
load database
from mysql://emre:'}+/XLSt|QSotm-(Gu96&U9quLv?u%oAV'@80.240.19.57:3306/Blog
into postgresql://postgres:'aA123456'@127.0.0.1:5432/blog
;

load database
from mysql://emre:'**pass**'@80.240.19.57:3306/Blog
into postgresql://postgres:'aA123456'@127.0.0.1:5432/blog
alter schema 'blog' rename to 'siyah'
;
